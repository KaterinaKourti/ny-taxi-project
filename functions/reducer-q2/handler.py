...
def handle(req):
    ...
    payload = { 'success': False, 'error': error } if error else { 'success': True, 'message': f'Reducer data for q2 have been successfully uploaded to Minio in bucket {reducer_bucket}' }
